...
<head>
    ...
    <!-- Google Material Icons (para "assignment" en los proyectos) -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="Jugador"
                                ...
                                <div class="mt-3">
                                    ...
                                    <!-- Botón Editar -->
                                    <a href="{{ route('users.edit') }}" class="btn btn-primary">Editar</a>

                                    <!-- Formulario para Eliminar -->
                                    <form action="{{ route('users.destroy') }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-outline-primary" style="background-color: red; color:white">Eliminar</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                    </div>
                    <!-- Información adicional sobre estadísticas y demás -->
                    <div class="card mt-3">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    {{ ucfirst($user->sexo) ?? 'No disponible' }}
                                </div>
                            </div>
                        </div>
                    </div>

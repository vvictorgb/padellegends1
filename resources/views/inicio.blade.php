...
<body id="section_1">
    ...
    <nav class="navbar navbar-expand-lg bg-white shadow-lg">
        <div class="container">
            <a href="#">
                <div
                    style="width: 100px; height: 80px; background-image: url('{{ asset('images/logo.png') }}'); background-size: cover; background-position: center;">
                </div>
            </a>
                        ...
                        <div class="carousel-inner h-100">
                            ...
                            <div class="carousel-item active h-100">
                                ...
                                <div class="carousel-image-wrap position-absolute top-0 start-0 w-100 h-100">
                                    <img src="{{ asset('images/slice1.jpg') }}" class="d-block w-100 h-100"
                                        alt="Imagen 1" style="object-fit: cover;">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                        <div class="about-image-wrap position-relative w-100"
                            style="height: 700px; overflow: hidden; border-radius: 12px;">

                            <img src="{{ asset('images/club.jpg') }}"
                                class="position-absolute top-0 start-0 w-100 h-100" alt="Foto del club"
                    ...
                    <div class="col-lg-6 col-12 d-flex flex-column">
                        <div class="about-thumb bg-white shadow-lg">
                            ...
                            <div class="about-info">
                                <small class="small-title">Sobre Nosotros <strong class="text-warning">
                                        02/05</strong></small>
                        ...
                        <nav>
                            <div class="nav nav-tabs flex-column align-items-baseline" id="nav-tab" role="tablist">
                                <button class="nav-link active" id="nav-pistas-tab" data-bs-toggle="tab"
                                    ...
                                    <span>Contamos con modernas pistas para todos los niveles, disponibles todo el
                                        año.</span>
                                </button>
                                ...
                                <button class="nav-link" id="nav-bar-tab" data-bs-toggle="tab"
                                    ...
                                    <span>Relájate antes o después de jugar con nuestra variada oferta
                                        gastronómica.</span>
                                </button>
                                ...
                                <button class="nav-link" id="nav-clases-tab" data-bs-toggle="tab"
                                    ...
                                    <span>Mejora tu técnica con entrenadores profesionales y planes
                                        personalizados.</span>
                                </button>
                            </div>
                        </nav>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="nav-pistas" role="tabpanel"
                                ...
                                <div style="width: 100%; height: 400px; overflow: hidden; border-radius: 8px;">
                                    <img src="{{ asset('images/fondo.png') }}" alt="Pistas de pádel"
                                        style="width: 100%; height: 100%; object-fit: cover;">
                                </div>
                                <h5 class="mt-4 mb-2">Nuestras Pistas</h5>
                                <p>Disponemos de 6 pistas de pádel de última generación, tanto cubiertas como al aire
                                    libre, con iluminación LED para partidos nocturnos.</p>
                                <ul>
                            ...
                            <div class="tab-pane fade" id="nav-bar" role="tabpanel" aria-labelledby="nav-bar-tab">
                                <div style="width: 100%; height: 400px; overflow: hidden; border-radius: 8px;">
                                    <img src="{{ asset('images/restaurante.jpg') }}" alt="Bar restaurante"
                                        style="width: 100%; height: 100%; object-fit: cover;">
                                </div>
                            ...
                            <div class="tab-pane fade" id="nav-clases" role="tabpanel"
                                ...
                                <div style="width: 100%; height: 400px; overflow: hidden; border-radius: 8px;">
                                    <img src="{{ asset('images/clases.jpg') }}" alt="Clases particulares"
                                        style="width: 100%; height: 100%; object-fit: cover;">
                                </div>
                                <h5 class="mt-4 mb-2">Clases Particulares</h5>
                                <p>Nuestros monitores titulados te ayudarán a perfeccionar tu juego. Clases para todas
                                    las edades y niveles.</p>
                                <ul>
    ...
    <footer class="site-footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <p class="copyright-text mb-0 me-4">Tu club de pádel en Valencia. Vive la pasión por el deporte,
                        compite, mejora y haz comunidad.
